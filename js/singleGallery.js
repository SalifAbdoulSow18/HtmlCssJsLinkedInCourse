...
window.addEventListener('load', ()=>{
    let galleriesRow = '{"gal1": {"title": "Bretagne 2019", "images": ["image-1.jpg","image-2.jpg","image-3.jpg","image-4.jpg","image-5.jpg","image-6.jpg"]},"gal2":{ "title": "Sacramento 2017", "images": ["image-7.jpg","image-8.jpg","image-9.jpg","image-10.jpg","image-11.jpg","image-12.jpg","image-13.jpg","image-14.jpg"]}}';
    let galleries = JSON.parse(galleriesRow);
    ...
    if(searchParams.has('id')) {
        ...
        window.location.pathname = 'home/salif/Bureau/Mes_projet/linkedIn/HtmlCssJs/galleries.html';
    }
...
function closeSinglePict(params) {
    let imageContainer = document.getElementById('galleryContainer');
    imageContainer.classList.toggle('visible');
}